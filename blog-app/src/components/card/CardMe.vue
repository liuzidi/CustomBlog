<template>
  <el-card>
    <h1 class="me-author-name">liuzidi</h1>
    <div class="me-author-description">
      <span><i class="el-icon-location-outline"></i> &nbsp;浙江大学</span>
      <span><i class="me-icon-job"></i>&nbsp;java项目练习</span>
    </div>
...
<script>
  export default {
    ...
    data() {
      return {
        qq: {title: 'QQ', message: '1506970780'},
        bilibili: {
          title: 'GitHub',
          message: 'github.com/liuzidi'
        }
      }
    },
    methods: {
